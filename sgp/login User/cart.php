...
$sql = "select * from `carttable` where username='$username' order by productId;";
...
<body>
    ...
    <div class="products-container">
        <div class="products">
            <table style="width: 100%; text-align: left; border:10px;" class="tab">
                <tr>
    ...
    <input type="button" value="Procced to Buy" class="pb" onclick="pb();">
    <p id="temp"></p>
