let carts = document.querySelectorAll('.add-cart-cart1, .add-cart-cart2 , .add-cart-cart3,.add-cart-cart4');
...
function addtotable(prid){
    $.ajax({
        url: "/sgp/Login User/carttable.php",
        method: "post",
        data: {id:JSON.stringify(prid)},
...
var clr=document.getElementsByClassName('pb');

function pb(){
    console.log('Btnclicked');
}

// document.getElementById('temp').innerHTML='clicked';